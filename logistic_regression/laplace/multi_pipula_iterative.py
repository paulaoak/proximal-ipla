...
output_file = "output_pipula_iterative_laplace.txt"
...
def run_algorithm_proximal(_):
    ...
    thetas_approx, _ = pip_ula(proximal_map = proximal_map_laplace_iteration_total, th = np.array([[theta0]]), X = X0, N = n_particles, design_matrix = design_matrix, data = labels, K = n_iterations, h = 0.06)
