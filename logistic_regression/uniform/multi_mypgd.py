...
output_file = "output_mypgd_uniform.txt"
...
def run_algorithm_proximal(_):
    ...
    thetas_approx, _ = mypgd(proximal_map = proximal_map_uniform_my_new, th = np.array([[theta0]]), X = X0, N = n_particles, design_matrix = design_matrix, data = labels, K = n_iterations, gamma = 0.01, h = 0.001)
