...
output_file = "output_pipgla_uniform.txt"
...
def run_algorithm_proximal(_):
    ...
    thetas_approx, _ = pipgla(proximal_map = proximal_map_uniform_my_new, th = np.array([[theta0]]), X = X0, N = n_particles, design_matrix = design_matrix, data = labels, K = n_iterations, gamma = 0.05, h = 0.05)
