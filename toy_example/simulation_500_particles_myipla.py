...
output_file = "output_myipla_toy.txt"
...
def run_algorithm_proximal(_):
    ...
    thetas_approx, _ = mypipla(proximal_map = proximal_map_laplace_approx, th = np.array([[theta0]]), X = X0, N = n_particles, data = labels, K = n_iterations, gamma = 0.3, h = 0.03)
